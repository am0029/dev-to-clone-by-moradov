        ...
        <Wrapper>
          <Card>
            ...
            {previewedUser.username === currentUser.username ? (
              <EditButton onClick={() => navigate('/customize')}>ویرایش پروفایل</EditButton>
            ) : (
            ...
            <Other>
              ...
              <CreatedAtWrapper>
                <FaBirthdayCake />
                <CreatedAt>ثبت نام شده در تاریخ {formatDate(previewedUser.createdAt, false)}</CreatedAt>
              </CreatedAtWrapper>
            </Other>
            <Footer>
              <EducationWrapper>
