              ...
              <NewPostWrapper>
                ...
                <InputWrapper>
                  <Label htmlFor='tags'>
                    تگ ها
                    {isTagsFocused && (
                      <Span>تگ ها با کاما جدا شده است </Span>
                    )}
                  </Label>
                  <Input
                    id='tags'
                ...
                <Submit onClick={handleUpdate}>تایید</Submit>
                {isError && <Error>خطا در انجام عملیات دوباره سعی کنید.</Error>}
                {!inputsFilled && <Error>همه ورودی ها اجباری میباشد</Error>}
                <DeletePost onClick={handleDeletion}>پاک کردن پست</DeletePost>
              </NewPostWrapper>
            )}
          </Wrapper>
        ) : (
